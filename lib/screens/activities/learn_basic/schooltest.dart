...
class SchoolTest extends StatefulWidget {
  const SchoolTest({Key key}) : super(key: key);
...
class _SchoolTestState extends State<SchoolTest> {
  ...
  // make class 1st
   ...
   List<WordFindQues> listQuestions = [
      ...
      WordFindQues(
        question: "i need a new -------",
        answer: "backpack",
        image:
            "assets/image/backpack.png",
      ),
       WordFindQues(
        question: "i go to school by------",
        answer: "bus",
        image:
            "assets/image/school bus.png",
      ),
        WordFindQues(
