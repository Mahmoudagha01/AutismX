import 'package:autismx/screens/activities/learn_time/QuarterThree.dart';
...
class QuarterTwo extends StatefulWidget {
  const QuarterTwo({Key key}) : super(key: key);
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    InkWell(
                      onTap: () {
                        _Speak('It\'s Half Past One O\'Clock');
                      },
                      child: Container(
                        width: 200,
                        height: 90,
