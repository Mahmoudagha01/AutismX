...
import 'package:autismx/screens/surveys/services/adult/qustionaireserviceupdate2.dart';
...
class AdultAttentionToDetail extends StatefulWidget {
  final int score1;
  final int score2;
final String name;
  final String age;
  final String gender;
  const AdultAttentionToDetail({Key key, this.score1, this.score2,@required this.name,
      @required this.age,
      @required this.gender,})
      : super(key: key);

  @override
  _AdultAttentionToDetailState createState() => _AdultAttentionToDetailState();
}

class _AdultAttentionToDetailState extends State<AdultAttentionToDetail> {
