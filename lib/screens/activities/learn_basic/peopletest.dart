...
class PeopleTest extends StatefulWidget {
  const PeopleTest({Key key}) : super(key: key);

  @override
  _PeopleTestState createState() => _PeopleTestState();
}

enum TtsState { playing, stopped }

class _PeopleTestState extends State<PeopleTest> {
  ...
  GlobalKey<_WordFindWidgetState> globalKey = GlobalKey();
   ...
   List<WordFindQues> listQuestions = [
      ...
      WordFindQues(
        ...
        answer: "sister",
       image:
            "assets/image/sister.png",
      ),
   
       WordFindQues(
        question: "My father's son is my?",
        answer: "brother",
        image:
            "assets/image/brother.png",
      ),
      WordFindQues(
        question: "My dad's brother is my?",
        answer: "uncle",
        image:
      ...
      WordFindQues(
        ...
        answer: "aunt",
        image:
            "assets/image/aunt.png",
      ),
        WordFindQues(
        question: "Who teach in the school ?",
        answer: "teacher",
        image:
            "assets/image/teacher2.png",
      )
