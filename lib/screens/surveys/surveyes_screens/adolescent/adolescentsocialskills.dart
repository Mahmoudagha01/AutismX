...
import 'package:autismx/screens/surveys/services/adolescent/questionnaire_service.dart';
...
class AdolescentSocialSkills extends StatefulWidget {
  final String name;
  final String age;
  final String gender;
  const AdolescentSocialSkills({
    Key key,
    @required this.name,
    @required this.age,
  ...
  @override
  _AdolescentSocialSkillsState createState() => _AdolescentSocialSkillsState();
}

class _AdolescentSocialSkillsState extends State<AdolescentSocialSkills> {
