...
import 'package:autismx/screens/surveys/services/child4/questionnaire_service.dart';
import 'package:autismx/screens/surveys/surveyes_screens/children4/child4_questionnaire.dart';
import 'package:flutter/material.dart';

class Child4SocialSkills extends StatefulWidget {
  final String name;
  final String age;
  final String gender;
  const Child4SocialSkills(
      {@required this.name, @required this.age, @required this.gender, Key key})
      : super(key: key);

  @override
  _Child4SocialSkillsState createState() => _Child4SocialSkillsState();
}

class _Child4SocialSkillsState extends State<Child4SocialSkills> {
