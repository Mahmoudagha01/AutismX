...
class MazeLevel7 extends StatefulWidget {
  @override
  _MazeLevel7State createState() => _MazeLevel7State();
}

ConfettiController _controllerCenterRight;

class _MazeLevel7State extends State<MazeLevel7> {
    int count=0;
  @override
  void initState() {
    super.initState();
