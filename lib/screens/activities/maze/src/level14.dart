...
class MazeLevel14 extends StatefulWidget {
  @override
  _MazeLevel14State createState() => _MazeLevel14State();
}

ConfettiController _controllerCenterRight;

class _MazeLevel14State extends State<MazeLevel14> {
