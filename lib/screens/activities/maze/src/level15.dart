...
class MazeLevel15 extends StatefulWidget {
  @override
  _MazeLevel15State createState() => _MazeLevel15State();
}

ConfettiController _controllerCenterRight;

class _MazeLevel15State extends State<MazeLevel15> {
  @override
  void initState() {
    super.initState();
