...
class Child4AttentionToDetail extends StatefulWidget {
  final int score1;
  final int score2;
  final String name;
  final String age;
  ...
  @override
  _Child4AttentionToDetailState createState() =>
      _Child4AttentionToDetailState();
}

class _Child4AttentionToDetailState extends State<Child4AttentionToDetail> {
