...
import 'package:autismx/screens/surveys/services/adolescent/qustionaireserviceupdate1.dart';
...
class AdolescentAttentionSwith extends StatefulWidget {
  final int score1;
  final String name;
  final String age;
  final String gender;
  const AdolescentAttentionSwith(
      {Key key,
      @required this.name,
      @required this.age,
  ...
  @override
  _AdolescentAttentionSwithState createState() => _AdolescentAttentionSwithState();
}

class _AdolescentAttentionSwithState extends State<AdolescentAttentionSwith> {
