...
import '../../puzzle/src/ui/utils/time_parser.dart';
import 'maze_widget.dart';

class MazeLevel8 extends StatefulWidget {
  @override
  _MazeLevel8State createState() => _MazeLevel8State();
}

ConfettiController _controllerCenterRight;

class _MazeLevel8State extends State<MazeLevel8> {
  @override
  void initState() {
    super.initState();
        ...
        children: [
          CustombackAppBar(context, () {
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                builder: (context) => const Imagination(),
              ),
            );
          }),
          Expanded(
