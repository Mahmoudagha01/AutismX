...
class FeelingTest extends StatefulWidget {
  const FeelingTest({Key key}) : super(key: key);

  @override
  _FeelingTestState createState() => _FeelingTestState();
}

enum TtsState { playing, stopped }

class _FeelingTestState extends State<FeelingTest> {
  ...
  // make class 1st
   ...
   List<WordFindQues> listQuestions = [
       ...
       WordFindQues(
        ...
        answer: "Exhausted",
       image:
            "assets/image/exhausted.png",
      ),
      WordFindQues(
        question: "I am ------",
        answer: "relaxed",
        image:
            "assets/image/relaxed.png",
      ),
      WordFindQues(
        question: "I am ------",
        answer: "stressed",
        image:
            "assets/image/stressed.png",
      ),
        WordFindQues(
        question: "I am -----",
        answer: "Confused",
        image:
            "assets/image/confused.png",
      ),
                    ...
                    children: const [
                      ...
                      Icon(
                        ...
                        color:  Colors.blue,
                         ...
                         Text("Get Hint",style: TextStyle(color: Colors.blue ,fontSize: 18),),
                    ],
                  ),
                ),
                IconButton(onPressed: (){_speak(currentQues.answer);}, icon: const Icon(Icons.volume_up_outlined,size: 35,color:Colors.blue))
              ],
