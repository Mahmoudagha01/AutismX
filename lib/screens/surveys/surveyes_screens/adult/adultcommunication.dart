...
import 'package:autismx/screens/surveys/services/adult/questionaireserviceupdate3.dart';
...
class AdultCommunication extends StatefulWidget {
  final int score1;
  final int score2;
  final int score3;
final String name;
  final String age;
  final String gender;
  const AdultCommunication({Key key, this.score1, this.score2, this.score3,@required this.name,
      @required this.age,
      @required this.gender})
      : super(key: key);

  @override
  _AdultCommunicationState createState() => _AdultCommunicationState();
}

class _AdultCommunicationState extends State<AdultCommunication> {
